...
//
// All nine clauses are complete, supplied by Lasertopia and checked word for word against
// what they sent.
//
...
// Bumped when clause 9 was completed. A waiver has to prove which wording was agreed to,
// so the version moves whenever a single character of the terms does.
export const TERMS_VERSION = '2026-08-lasertopia.ca-r2';
...
export const WAIVER_CLAUSES = [
  ...
  'That you have read this entire document and completely understand its contents. You also '
  + 'acknowledge that any questions about the content of this document or use of the premises '
  + 'and facilities have been answered by a representative of LASERTOPIA INC.',
];

/** Index (1-based) of any clause known to be incomplete, so the page can say so. Empty. */
export const INCOMPLETE_CLAUSES = [];
