...
export const addNoteImage           = (...a) => Promise.resolve(pick().addNoteImage(...a));
export const readNoteImage          = (...a) => Promise.resolve(pick().readNoteImage(...a));
export const deleteNoteImage        = (...a) => Promise.resolve(pick().deleteNoteImage(...a));
export const listParties             = (...a) => Promise.resolve(pick().listParties(...a));
export const slotsFor                = (...a) => Promise.resolve(pick().slotsFor(...a));
export const saveSlots               = (...a) => Promise.resolve(pick().saveSlots(...a));
export const resetSlots              = (...a) => Promise.resolve(pick().resetSlots(...a));
export const reportsFor              = (...a) => Promise.resolve(pick().reportsFor(...a));
export const addWaiver               = (...a) => Promise.resolve(pick().addWaiver(...a));
export const listWaivers             = (...a) => Promise.resolve(pick().listWaivers(...a));
